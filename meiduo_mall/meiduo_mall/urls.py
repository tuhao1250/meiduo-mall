...
urlpatterns = [
    ...
    path('xadmin/', xadmin.site.urls),  # 包含xadmin的urls
    ...
    path('', include('orders.urls', namespace="orders")),  # 包含订单模块的urls
    path('', include('payment.urls', namespace="payment")),  # 包含支付模块的urls
]
