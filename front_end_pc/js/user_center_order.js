...
// // <<<<<<< HEAD
// // <<<<<<< HEAD
//             axios.get(this.host+'/orders/all/', {
// // =======
// //             axios.get(this.host+'/orders/order/', {
// // >>>>>>> origin/gezhaoyu
// // =======
//             // axios.get(this.host+'/orders/', {
// //             axios.get(this.host+'/goods/', {
// // >>>>>>> origin/lijianhao
//                     headers: {
...
//                             this.orders[i].create_time = create_time.substring(0, 9) + ' ' + create_time.substring(11, 18);
// // >>>>>>> origin/gezhaoyu
// // =======
// // >>>>>>> origin/lijianhao
//                         }
...
var vm = new Vue({
    ...
    methods: {
        ...
        on_operate_order: function (index) {
            ...
            // 去支付
            if (order.status===1) {
                axios.get(this.host+'orders/'+order.oid+'/payment/', {
                        headers: {
                            'Authorization': 'JWT ' + this.token
                        },
                        responseType: 'json'
